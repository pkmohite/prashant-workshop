...
def compress_gif(gif_file, output_file, quality=10):
    ...
    with Image.open(gif_file) as im:
        ...
        # Save the compressed GIF file
        im.save(output_file, **save_params)
    
# # Example usage
# gif_file = "animation.gif"
# output_file = "compressed_animation.gif"
# compress_gif(gif_file, output_file, quality=10)
